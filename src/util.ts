export class Util {
  static calculateBaseId(resourceId: number): number {
  ...
  static formatPrice(price: number) {
    ...
    else if (price <= 950) return Math.ceil(price / 50) * 50;
    else if (price <= 9900) return Math.ceil(price / 100) * 100;
    else if (price >= 10000 && price <= 49750) return Math.ceil(price / 250) * 250;
    else if (price >= 50000 && price <= 100000) return Math.ceil(price / 500) * 500;
    else return Math.ceil(price / 1000) * 1000;
  }

  static decreasePrice(price: number) {
    if (price < 150) {
      return 150;
    }
  ...
  static increasePrice(price: number) {
    if (price < 150) {
      return 150;
    }
  ...
  static getRandomBidPrice(minPrice: number): number {
    let list: number[] = [];
    let current = 0;
  ...
  static getRandomBinPrice(minPrice: number, maxPrice: number): number {
    let list: number[] = [];
