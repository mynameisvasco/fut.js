...
export class MoveItemRequest extends BaseRequest {
    ...
    async perform(httpClient) {
        const response = await httpClient.put(`${Constants.BaseUrl}/item`, { itemData: [{ id: this.itemId, pile: this.pile }] }, { headers: { Host: Constants.UtasHost, "Content-Type": "application/json" } });
